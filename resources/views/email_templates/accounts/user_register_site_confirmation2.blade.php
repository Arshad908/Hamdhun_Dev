...
<table align="center" cellpadding="0" cellspacing="0" class="container-for-gmail-android" width="100%">
    ...
    <td align="center" valign="top" width="100%" style="background-color: #f7f7f7;" class="content-padding">
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="header-lg">
              Welcome to Noyel.com
            </td>
          </tr>
          <tr>
            <td class="free-text">
              Thank you for signing up with NOYEL.COM ! We hope you enjoy your time with us. Check out some of our newest offers below or the button to view your varify account.
            </td>
          </tr>
          <tr>
            <td class="button">
              ...
              <![endif]--><a class="button-mobile" href="{{route('site_make_confirm_account_active',[$date['enc_type_65'],$date['enc_type_13']] )}}"
              style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Varify Account</a></div>
            </td>
          </tr>
        </table>
      </center>
  ...
  <tr>
    <td align="center" valign="top" width="100%" style="background-color: #ffffff;  border-top: 1px solid #e5e5e5; border-bottom: 1px solid #e5e5e5;">
      <center>
        <table cellpadding="0" cellspacing="0" width="600" class="w320" style="display: none;">
          <tr>
            <td class="content-padding">
      ...
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          <tr>
            ...
            <td style="padding: 25px 0 25px">
              Powered by
              <strong>softcrack.com</strong> <br /><br />
            </td>
          </tr>
        </table>
      </center>
