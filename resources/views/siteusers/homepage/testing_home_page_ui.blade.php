...
<body>
	...
	<main>
		...
		<section class="hero_in tours">
			<div class="wrapper">
				<div class="container">
					<h1 class="fadeInUp"><span></span>Paris tours grid sidebar</h1>
				</div>
			</div>
		</section>
		<!--/hero_in-->
		...
		<div class="container-fluid mk_container_inner_lr_10 margin_60_35">
			<div class="row">
						...
						<div class="collapse show" id="collapseFilters">
							<div class="filter_type">
								...
								<ul>
									...
									<li>
										<label>
											<input type="checkbox" class="icheck">Museums <small>(45)</small>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" class="icheck">Churches <small>(30)</small>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" class="icheck">Historic <small>(25)</small>
										</label>
									</li>
									<li>
										<label>
											<input type="checkbox" class="icheck">Walking <small>(56)</small>
										</label>
									</li>
								</ul>
							</div>
	...
	<!-- COMMON SCRIPTS -->
    <!-- <script src="{{asset('postAdvertisersLoad/js/jquery-2.2.4.min.js')}}"></script> -->
	...
	<script src="{{asset('postAdvertisersLoad/js/markerclusterer.js')}}"></script>
	<script src="{{asset('postAdvertisersLoad/js/map_tours.js')}}"></script>
	<script src="{{asset('postAdvertisersLoad/js/infobox.js')}}"></script>
