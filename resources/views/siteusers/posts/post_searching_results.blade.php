...
<!--       				<div class="col-lg-12">
 ...
 -->				<!-- /row -->
        ...
        @foreach($searching_status as $company_posts_data)
                 ...
                 @for($posts = 0 ; $posts < count($vailable_advertiesments) ; $posts++)  
                  ...
                  @if($data["pmid"] == $now_ongoing_array_master_key)
        					...
        					<div class="col-sm-2 padding_5555">
        						  <a target="_blank" href="{{route('single_advetrtisers',['post_name_title'=>$data['ptitle'],'sec'=>base64_encode($data['pid']+1502154+58254282),'sect'=>true] )}}">  	
