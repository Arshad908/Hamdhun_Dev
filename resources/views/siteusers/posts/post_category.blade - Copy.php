      ...
      <div class="row">
        ...
        @foreach($load_master_category_advertiesments as $mcategory_posts_data)
              ...
              @if(!array_key_exists($mcategory_posts_data->psubmasterid, $checked_categoryies))
                <?php array_push( $checked_categoryies,array($mcategory_posts_data->psubmasterid => $mcategory_posts_data->psubname) ); ?>
              @endif
            ...
            <div class="main_title_3">
              ...
              @endif
                  ...
                  @if($data["psubmasterid"] == $now_ongoing_array_master_key)
                    ...
                    <img src="{{asset($data['displayimage'])}}" style="width: 100%;height: 140px;" alt="{{$data['ptitle']}}">
                    <div class="card-body">
