...
@if( session("account_type") == 96 || empty(session("account_type")) || session("card_info_saved") == false )
<style type="text/css">
  .error_information_incomplete{
...
<main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="icon fa fa-file-o"></i>&emsp;Post</h1>
          <p></p>
        </div>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="row">
            <div class="col-lg-12">
              <h2 class="mb-3 line-head" id="buttons">Form incomplete</h2>
            </div>
            <div class="col-sm-4 col-sm-off-3">
              <div class="card @if( !empty(session('account_type')) ) error_information_incomplete @endif">
                <div class="card-header">
                    <h5>Step 1: Create Profile</h5>
                </div>
                <div class="card-body">
                   <a href="{{route('updateuserprofiledatainweb')}}">Create</a> 
                </div>
              </div>   
            </div>
            <div class="col-sm-4">
              <div class="card @if( session('account_type') == 114 ) error_information_incomplete @endif">
                <div class="card-header">
                    <h5>Step 2: Choose Advertiser</h5>
                </div>
                <div class="card-body">
                   <a href="{{route('updateuserprofiledatainweb')}}">Create</a> 
                </div>
            ...
            <div class="col-sm-4">
              <div class="card @if( session('card_info_saved') == true ) error_information_incomplete @endif">
                <div class="card-header">
                    <h5>Step 3: Payment Mode</h5>
                </div>
                <div class="card-body">
                   <a  href="@if(session('account_type') == 114) ? route('updateuserprofiledatainweb') @else # @endif">Create</a> 
                </div>
              </div>   
            </div>
        ...
        <div class="col-md-12">
          ...
          @if(Session::get('post_uploade_status') == 200)
           <div class="success post_created" id="post_created_success_fully">
              <h5>Well Done. Post created successfully. Process started to comfirm</h5>
            </div>
          @endif  
          ...
          <div class="col-sm-6">
              <div class="col-md-12 mb-4" id="">
                   ...
                   <input class="form-control" type="text" name="ndl_make_title_post" id="ndl_make_title_post">
                   <small class="error_input_text" id="ndl_make_title_post_error">Input size between 5 to 50</small>
              </div>
               <div class="col-md-12 mb-4" id="">
                      <label>Content Of Post *</label>
                   <textarea spellcheck="true" class="form-control" rows="7" cols="15" name="ndl_make_content_of_post" id="ndl_make_content_of_post"></textarea>
              ...
              <div class="col-md-12 mb-4" id="">
                   ...
                   <input class="form-control" type="url" name="ndl_make_urls_of_post" id="ndl_make_urls_of_post">
              </div>
              <!-- <div class="col-md-12 mb-4" id="">
          ...
          <div class="col-sm-6">
            ...
            <div class="col-md-6 col-sm-12 mb-4" id="">
                 ...
                 <select class="form-control texting_subcategory" id="mstr_select_actegory" name="mstr_select_actegory">
                  @foreach($data_j[0] as $emails)
                    <option value="{{$emails->mid+524}}">{{ucfirst($emails->mname)}}</option>
                  @endforeach      
                 </select>
            ...
            <div class="col-md-6 col-sm-12 mb-4 " id="product_condition_display_content">
                  ...
                  <div class="animated-radio-button">
                   <label>
                          <input type="radio" checked="checked" name="products_conditions_delect" value="new" id="nd_products_condition_detect" ><span class="label-text"></span>New 
                        </label>
                  </div> &emsp;
                  <div class="animated-radio-button">
                   <label>
                          <input type="radio" name="products_conditions_delect" value="used" id="nd_products_condition_detect" ><span class="label-text"></span>Used 
                        </label>
                  </div>
                  </div>
              </div>
            ...
            <div class="col-md-6 col-sm-12 mb-4" id="">
                   ...
                   <select class="form-control" name="ndl_make_visible_range_of_post" id="ndl_make_visible_range_of_post"> 
                      <option value="@php echo base64_encode(98+5789); @endphp">Word Wide Display</option>
                      <option value="@php echo base64_encode(115+5789); @endphp">Only Local Display</option>
                   </select>
              </div>
             <div class="col-md-6 col-sm-12 mb-4" id="">
                    <label>Price *</label>
                   <input class="form-control" value="" type="text" name="ndl_make_price_chanrge_of_post" id="ndl_make_price_chanrge_of_post">
              ...
              <div class="col-md-6 col-sm-12 mb-4" id="">
                   ...
                   <div class="animated-checkbox" style="margin-top: 5px;">
                      <label>
                        <input type="checkbox" id="ndl_make_this_offer_of_post" onclick="checkAdvertisingForPromotions()" name="ndl_make_this_offer_of_post"><span class="label-text">Promotion</span>
                      </label>
                   </div>
              </div>
              <div class="col-md-6 col-sm-12 mb-4" id="promotional_advertising_date_form">
                    <label>Offer Expires On</label>
                   <input class="form-control" type="date" name="ndl_make_expire_date_of_post" id="ndl_make_expire_date_of_post">
              ...
              <div class="col-md-6 col-sm-12 mb-4" id="promotional_advertising_price_form">
                   ...
                   <input class="form-control" type="text" name="ndl_make_offer_price_chanrge_of_post" id="ndl_make_offer_price_chanrge_of_post">
           ...
           <div class="tile-footer">
              <button class="btn btn-primary" type="button" onclick="onCheckPostData();" id="parst_site_post_upload" name="parst_site_post_upload">Submit</button>
            </div>
          </div>
        </div>
    </div>
...
<script>
      ...
      function onCheckPostData(){ 
          ...
          if(rq_advertisement_postTitle && rq_advertisement_postContent && rq_advertisement_mainCat && rq_advertisement_subCat && rq_advertisement_price && rq_advertisement_prm_price && rq_advertisement_prm_date)
          {
              ...
              $("#make_user_new_upload").attr("action","{{route('make_user_upload_posts_new_market')}}");
      ...
      function Display_selected_sub_category(){
        ...
        if(master_categry_id == 605 || master_categry_id == 617 || master_categry_id == 618 || master_categry_id == 600 ){
