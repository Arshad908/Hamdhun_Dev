...
<head>
  ...
  <title>Offer! Confirmation | noydl.com</title>
                  ...
                  <td class="mini-block">
                    <table cellpadding="0" cellspacing="0" width="100%">
                      ...
                      <tr>
                        <td class="code-block">
                          @php
                            $prodata_code = explode(".",base64_decode($prodata['promocodetouser']));
                          @endphp
                          {{strtoupper($prodata_code[1])}}
                        </td>
                      </tr>
                      @if(base64_decode($prodata['promooffertype']) == 85)
                      <tr>
                        <td class="button">
                          <div><!--[if mso]>
                          ...
                          <![endif]--><a class="button-mobile" href="{{route('user_activate_prmoto_code',['check'=>$prodata['promocodetouser'] , 'follow' => base64_encode(rand(15000,25000) ) ])}}"
                          style="background-color:#ff6f6f;border-radius:5px;color:#ffffff;display:inline-block;font-family:'Cabin', Helvetica, Arial, sans-serif;font-size:14px;font-weight:regular;line-height:45px;text-align:center;text-decoration:none;width:155px;-webkit-text-size-adjust:none;mso-hide:all;">Activate Now</a></div>
                        </td>
                      </tr>
                      @endif
                    </table>
